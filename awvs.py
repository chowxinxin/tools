#awvs批量扫描
#接口文档：http://wp.blkstone.me/2019/11/awvs-api-documents/
import requests
import hashlib
import json
import argparse

username = 'hacksec@hacksec.com'
password = 'root123!@#'
...
class Awvs():
    ...
    def scanTarget(self, target_id):
        info = '{"target_id":"xxxxxxxxxxxx","profile_id":"11111111-1111-1111-1111-111111111111","schedule":{"disable":false,"start_date":null,"time_sensitive":false}}'
